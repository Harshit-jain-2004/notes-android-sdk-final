...
import kotlinx.android.synthetic.main.sn_note_gallery_item_single_image.view.*

class NoteGalleryItemSingleImage(view: View) : NoteGalleryItem.NoteGalleryImage(view) {
